...
const getCustomers = async () => {
    try {
        const findCustomers = await customerRepo.getCustomers();
        if (!findCustomers) {
            return handleNotFound("Khong tim thay customers");
        }
        return handleSuccess("Thanh cong", findCustomers)
    } catch (e) {
...
const customerService = {createCustomer, deleteCustomer, getCustomers};
